...
class SnippetManager
  ...
  def build_ui
    ...
    controls_box.pack_start(save_button, expand: false, fill: false, padding: 0)

    reload_button = Gtk::Button.new(label: "Recharger")
    reload_button.signal_connect('clicked') { reload_snippet }
    controls_box.pack_start(reload_button, expand: false, fill: false, padding: 0)
  ...
  def save_as_snippet
    ...
    content_area.pack_start(box, expand: true, fill: true, padding: 0)

    name_label = Gtk::Label.new("Nom du snippet:")
    box.pack_start(name_label, expand: false, fill: false, padding: 0)

    name_entry = Gtk::Entry.new
    name_entry.text = @current_snippet_name || "Nouveau snippet"
    box.pack_start(name_entry, expand: false, fill: false, padding: 0)
