...
class DroneSimulation < Gtk::Window
  def initialize
    ...
    set_title('Simulation de Drone 2D - Waypoints par clic')
  ...
  def setup_ui
    ...
    # Instructions
    instructions = Gtk::Label.new("CLIQUEZ GAUCHE pour ajouter un waypoint | ESPACE: pause/reprendre")
  ...
  def draw(widget, cr)
    ...
    # Waypoints (dessinés en premier pour être sous le drone)
